...
const formatSuggestedMoveWinrate = (
...
const GameBoard = forwardRef<GameBoardHandle, GameBoardProps>(
    function GameBoard(
        ...
        const redrawBoardAndStones = (
            ...
            const sideToMove = sideToMoveAtMoveIndex(
                analysisIndex,
                replayMoves
            );
        ...
        const handlePassMove = () => {
            ...
            getAIMove(nextMoves)
                ...
                .catch((error) => {
                    console.error(
                        "Error while getting AI move after pass:",
                        error
                    );
                });
        };
        ...
        const handlePassMoveRef = useRef(handlePassMove);
        handlePassMoveRef.current = handlePassMove;
        useImperativeHandle(
            ref,
            () => ({
                handlePassMove: () => handlePassMoveRef.current(),
            }),
            []
        );
