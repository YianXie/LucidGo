...
LucidGo is an open-source web-application for visually analyzing Go games. You can see AI-powered move analysis in real-time, with vary configurations that the user can adjust freely.
...
* **Compare games**: Users can compare multiple games to visually see the difference in results between different analysis configs
